    ...
    ElevatedCard(
        ...
        LazyColumn {
            items(textResultStyleList) {
                TextResult(fontWeight = it.fontWeight, fontFamilyy = it.fontFamily)
            }
        }
    }
}
...
@Composable
fun TextResult(fontWeight: FontWeight, fontFamilyy: FontFamily) {
    val newText by rememberSaveable {
        mutableStateOf("Home")
    }
